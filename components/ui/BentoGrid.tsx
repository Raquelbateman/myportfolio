                ...
                <div className={`${id === 5 && "flex justify-center h-full"}`}>
                    ...
                    >
                        {id === 2 ? (
                            ...
                            <>
                                <div className="font-sans font-bold text-neutral-200 text-2xl md:text-3xl lg:text-5xl mb-4 z-10">
                                    {title}
                                </div>
                                <div className="font-sans font-light text-neutral-200 text-sm md:text-base lg:text-lg max-w-3xl leading-relaxed z-10 mb-6">
                                    {description}
                                </div>
                            </>
                        )}
                            ...
                            >
                                <div className="sm:col-span-2 lg:col-span-6 flex flex-col items-center mb-5 lg:mb-0 max-w-3xl">
                                    ...
                                    <div className="flex flex-row gap-4 mt-6">
                                        ...
                                        <a
                                            href="https://www.linkedin.com/in/alicia-spruell-082822301/"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                        >
                                            <MagicButton
                                        ...
                                        <a
                                            href="https://www.codewars.com/users/AliciaRaquel1017"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                        >
                                            <MagicButton
