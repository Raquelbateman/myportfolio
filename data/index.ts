...
export const gridItems = [
  ...
  {
    id: 2,
    title: "Alicia Spruell",
    description: "Your Friendly Full Stack Developer",
...

  {
    id: 5,
    title: "About Me",
    description: "I am a full-stack developer who enjoys UI development.",
  ...
  },
  {
    ...
    description: "View all of my previous projects",
    className: "lg:col-span-2 md:col-span-3 md:row-span-1",
    imgClassName: "",
